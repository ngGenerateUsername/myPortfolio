    ...
    <div className="home__container container grid">
        <div className="home__content grid">
            <div className="home__social">
                <a href="https://www.linkedin.com/in/ahmedbh97/" target="_blank" className="home__social-icon">
            ...
            <div className="home__data">
                <h1 className="home__title">Hi, I'm Ahmed</h1>
                <h3 className="home__subtitle">FullStack developer</h3>
                <p className="home__description">
                A FullStack web Developer with a passion for building efficient server-side systems that drive seamless and dynamic web experiences.
                </p>
