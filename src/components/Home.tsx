        ...
        <div className="home-container container grid">
            <div className="home-content grid">
                <div className="home-social">
                    ...
                    <a href="https://dribbble.com/" target="_blank" className="home-social-icon">
                        <i className="fab fa-dribbble"></i>
                    </a>
                    <a href="https://github.com/" target="_blank" className="home-social-icon">
                ...
                <div className="home-img">
                    <svg className="home-blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g mask="url(#mask0)">
                            ...
                            <image className="home-blob-img" x='1' y='-25' xlinkHref="./../../public/img/mrblue.png" />
